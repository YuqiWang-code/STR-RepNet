...
# HAM-CD baseline / Run1 — LEVIR-CD-256
GPU=1
...
CKPT_DIR=/share_datasets/yqwang/checkpoints/STR-RepNet/baseline/Run1/${DATASET}
LOG_DIR=/home/yqwang/outputs/STR-RepNet/baseline/Run1/${DATASET}
