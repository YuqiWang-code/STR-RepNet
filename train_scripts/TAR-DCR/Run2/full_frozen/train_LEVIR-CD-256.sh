...
# STR-RepNet TAR-DCR Run2 — full_frozen / LEVIR-CD-256
GPU=1
DATASET=LEVIR-CD-256
REP_MODE=full
ENCODER_TRAIN=frozen
USE_RESIDUAL=1
EXP=full_frozen
EPOCHS=300
BATCH=16
...
CKPT_DIR=/share_datasets/yqwang/checkpoints/STR-RepNet/TAR-DCR/Run2/${EXP}/${DATASET}
LOG_DIR=/home/yqwang/outputs/STR-RepNet/TAR-DCR/Run2/${EXP}/${DATASET}
